export const ChatHeader = () => {
  return (
    <header className="relative w-full py-16 px-4 border-b border-primary/10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 className="font-orbitron font-black text-7xl md:text-8xl tracking-widest mb-4 title-glow"
            style={{
